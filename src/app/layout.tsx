  ...
  return (
    <html lang="es" suppressHydrationWarning>
      <head>
        ...
        <meta
          name="description"
          content="Una aplicación para valorar y gestionar el cronograma de proyectos."
        />
        <link
          rel="icon"
          href="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2024%2024'%20fill='none'%20stroke='currentColor'%20stroke-width='2'%20stroke-linecap='round'%20stroke-linejoin='round'%3E%3Crect%20width='18'%20height='18'%20x='3'%20y='3'%20rx='2'/%3E%3Cpath%20d='M7%207h3v3H7z'/%3E%3Cpath%20d='M14%207h3v3h-3z'/%3E%3Cpath%20d='M7%2014h3v3H7z'/%3E%3Cpath%20d='M14%2014h3v3h-3z'/%3E%3C/svg%3E"
        />
      </head>
      <body
